...
_UBSAN_STANDALONE_CXX_LIB_NAME = "libclang_rt.ubsan_standalone_cxx-x86_64.a"
...
def _extract_build_params(
    ...
    if sanitizer == "undefined":
        ...
        ubsan_lib_path = _find_llvm_lib(
            repository_ctx,
            _UBSAN_STANDALONE_CXX_LIB_NAME,
        )
        repository_ctx.symlink(repository_ctx.path(ubsan_lib_path), _UBSAN_STANDALONE_CXX_LIB_NAME)
        stub_srcs.append(_UBSAN_STANDALONE_CXX_LIB_NAME)
